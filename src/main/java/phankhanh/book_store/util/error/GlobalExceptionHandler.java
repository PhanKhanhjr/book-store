...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<RestResponse<Object>> handleInvalidOtpException(InvalidOtpException e) {
        RestResponse<Object> res = new RestResponse<>();
        res.setStatusCode(HttpStatus.BAD_REQUEST.value());
        res.setError("Invalid OTP");
        res.setMessage(e.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(res);
    }
    ...
    public ResponseEntity<RestResponse<Object>> handleInvalid(IdInvalidException e) {
        RestResponse<Object> res = new RestResponse<>();
        res.setStatusCode(HttpStatus.BAD_REQUEST.value());
    ...
    @ExceptionHandler(value = DataInvalid.class)
    public ResponseEntity<RestResponse<Object>> handleDataInvalid(DataInvalid e) {
        RestResponse<Object> res = new RestResponse<>();
        res.setStatusCode(HttpStatus.BAD_REQUEST.value());
